...
return ( <div className="text-center mt-10 text-white"> <h2 className="text-xl font-bold text-red-400">
No eligible recyclers found </h2> <button
       onClick={onBack}
...
return ( <div className="min-h-screen bg-gradient-to-br from-[#062e23] via-[#0b3d2e] to-[#0f5132] p-4 text-white">
  ...
  <div className="overflow-x-auto">
    <table className="w-full backdrop-blur-lg bg-white/10 border border-white/20 rounded-2xl overflow-hidden shadow-xl">
      ...
      <tbody>
        {results.map((r, index) => {
          const isExternal =
            String(r._id).startsWith("g_") ||
            String(r._id).startsWith("ext_") ||
            String(r._id).startsWith("fsq_");
              ...
              <td className="p-3">
                {!isExternal ? (
                  <button
                    ...
                    className="bg-green-400 px-3 py-1 rounded-lg hover:bg-green-300 transition text-black font-semibold"
                  >
                    Select
                  </button>
                ) : r.placeId ? (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-blue-500 px-3 py-1 rounded-lg hover:bg-blue-600 transition text-white text-sm"
                  >
                    View 🌍
                  </a>
                ) : (
