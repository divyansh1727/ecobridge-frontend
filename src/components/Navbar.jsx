...
export default function Navbar({ currentStep, goHome, goLogin }) {
    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-green-950/90 backdrop-blur-md shadow-md">
      <div className="max-w-7xl mx-auto px-6 py-2 md:py-3 flex items-center justify-between">
        ...
        <ul className="hidden md:flex gap-8 text-white font-semibold items-center">
          ...
          <li
            onClick={goLogin}
            className="bg-green-600 px-4 py-1 rounded-lg hover:bg-green-500 transition cursor-pointer"
          >
            Recycler Login
          </li>
        </ul>
      ...
      {isOpen && (
        ...
        >
          ...
          <motion.li
            ...
            className="bg-green-600 px-6 py-2 rounded-lg hover:bg-green-500 transition cursor-pointer"
          >
             Login
          </motion.li>
        </motion.ul>
